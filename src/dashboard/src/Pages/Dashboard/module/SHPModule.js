...
const SHPModule = () => {
  ...
  const [motionDetect, setMotionDetect] = useState();
  ...
  const dispatchMotion = () => {
    if(!motionEnable)
      return toast.info("Motion Detector is not active");
    setCounter(delayMotion);
    setTimeout(() => {
  ...
  return <Grid container direction="column">
    ...
    <div className={classes.shpBoxes}>
      <div className={classes.moduleBoxHeader}>Enable Motion Detector</div>
      <div className={classes.moduleBoxBody}>
        <FormControl>
          <FormControlLabel label={"Enable Detect Motion"}
    ...
    <div className={classes.shpBoxes}>
      <div className={classes.moduleBoxHeader}>Simulate New Motion</div>
      <Grid container className={classes.moduleBoxBody} alignItems={'center'}>
        <Button color="primary" variant="contained" onClick={dispatchMotion}>Dispatch New Motion</Button>
        {counter > 0 &&
        <Typography className={classes.shpCounter}>{counter}</Typography>
        }
      </Grid>
    </div>
  </Grid>
